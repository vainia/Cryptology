...
print "plaintext = 0b1101011100101000"
key = 0b0100101011110101
print "key = 0b0100101011110101"
ciphertext = 0b0010010011101100
print "ciphertext = 0b0010010011101100"
print "keyExp(key)"
keyExp(key)
print "encrypt(plaintext) =", bin(encrypt(plaintext))
print "decrypt(ciphertext) =", bin(decrypt(ciphertext))